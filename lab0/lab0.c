...
void part2() {
    ...
    // ==> Ans: run-time error(stack overflow)
    fillArray(array, 10);
    ...
    // ==> Ans: value = 2 because the value of 0*3+2 is assigned
    //          to the memory pointed by &value, which is value
    fillArray(&value, 1);
...
void part4() {
    ...
    printf("Approximate runtime i-j-k = %d\n",(int)(clock() - timer));
    ...
    printf("Approximate runtime i-k-j = %d\n",(int)(clock() - timer));
    ...
    printf("Approximate runtime j-i-k = %d\n",(int)(clock() - timer));
    ...
    printf("Approximate runtime j-k-i = %d\n",(int)(clock() - timer));
    ...
    printf("Approximate runtime k-j-i = %d\n",(int)(clock() - timer));
    ...
    printf("Approximate runtime k-i-j = %d\n",(int)(clock() - timer));
